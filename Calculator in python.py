...
screen = Entry(root,textvar=scvalue,font="Verdana 20",fg="Black",bg="mistyrose",bd=4,justify=RIGHT)
...
b.bind("<Button-1>", click)
b = Button(f, text="-", padx=31, pady=20, font="lucida 35 bold")
b.pack(side=LEFT, padx=18, pady=5)
b.bind("<Button-1>", click)
b = Button(f, text="*", padx=32, pady=22, font="lucida 35 bold")
b.pack(side=LEFT, padx=18, pady=5)
b.bind("<Button-1>", click)
f.pack()
f = Frame(root, bg="grey")
...
b.bind("<Button-1>", click)
b = Button(f, text="+", padx=29, pady=18, font="lucida 35 bold")
...
f.pack()
f = Frame(root, bg="grey")
b = Button(f, text="c", padx=26, pady=22, font="lucida 35 bold")
b.pack(side=LEFT, padx=18, pady=12)
b.bind("<Button-1>", click)
b = Button(f, text=".", padx=26, pady=22, font="lucida 35 bold")
b.pack(side=LEFT, padx=18, pady=12)
b.bind("<Button-1>", click)
b = Button(f, text="00", padx=26, pady=22, font="lucida 35 bold")
b.pack(side=LEFT, padx=18, pady=12)
b.bind("<Button-1>", click)
f.pack()
root.mainloop()
